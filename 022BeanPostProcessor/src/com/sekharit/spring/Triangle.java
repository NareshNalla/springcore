...
public class Triangle implements Shape {
	...
	public void setPointOne(Point pointOne) {
		System.out.println("Triangle.setPointOne(Point pointOne)");
		this.pointOne = pointOne;
	}

	public void setPointTwo(Point pointTwo) {
		System.out.println("Triangle.setPointTwo(Point pointTwo)");
		this.pointTwo = pointTwo;
	}

	public void setPointThree(Point pointThree) {
		System.out.println("Triangle.setPointThree(Point pointThree)");
		this.pointThree = pointThree;
	}
